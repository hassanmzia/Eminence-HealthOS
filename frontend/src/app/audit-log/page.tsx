...
const demoAuditEntries: AuditEntry[] = [
  ...
  { id: "AUD-058", timestamp: "2026-03-15T11:18:20Z", eventType: "Authentication", user: "pharmacist.lee@eminence.health", action: "Login", resource: "/auth/login", ipAddress: "10.0.4.15", status: "success", duration: 202, details: { requestMethod: "POST", requestPath: "/api/v1/auth/login", responseCode: 200, sessionId: "sess_5b1d8c", userAgent: "Mozilla/5.0 Firefox/125", notes: "Pharmacist login – prescription verification queue" } },
  { id: "AUD-059", timestamp: "2026-03-15T11:22:00Z", eventType: "Clinical", user: "pharmacist.lee@eminence.health", action: "Verify Prescription", resource: "Rx #88450 – Losartan 50mg", ipAddress: "10.0.4.15", status: "success", duration: 155, details: { requestMethod: "PATCH", requestPath: "/api/v1/prescriptions/88450/verify", requestPayload: '{"verified":true,"pharmacistNotes":"Dosage appropriate, no contraindications"}', responseCode: 200, notes: "Prescription verified by pharmacist" } },
  { id: "AUD-060", timestamp: "2026-03-15T11:25:35Z", eventType: "System", user: "system", action: "Queue Processing", resource: "Message Queue: prescription-notifications", ipAddress: "10.0.10.1", status: "success", duration: 1200, details: { requestMethod: "POST", requestPath: "/internal/queues/prescription-notifications/process", responseCode: 200, responseBody: '{"processed":12,"failed":0,"pending":3}', notes: "Batch notification processing for verified prescriptions" } },
  { id: "AUD-061", timestamp: "2026-03-15T11:30:10Z", eventType: "Data Access", user: "dr.williams@eminence.health", action: "View Discharge Summary", resource: "Patient #10445 – Discharge Summary", ipAddress: "10.0.3.45", status: "success", duration: 178, details: { requestMethod: "GET", requestPath: "/api/v1/patients/10445/encounters/latest/discharge", responseCode: 200, notes: "HIPAA audit – provider reviewed discharge documentation" } },
  { id: "AUD-062", timestamp: "2026-03-15T11:35:50Z", eventType: "Configuration", user: "admin@eminence.health", action: "Update Audit Retention Policy", resource: "Policy: Audit Log Retention", ipAddress: "10.0.1.5", status: "success", duration: 110, details: { requestMethod: "PUT", requestPath: "/api/v1/config/audit/retention", requestPayload: '{"retentionDays":2555,"archiveEnabled":true,"compressionLevel":"high"}', responseCode: 200, notes: "Retention extended to 7 years per HIPAA compliance requirements" } },
  { id: "AUD-063", timestamp: "2026-03-15T11:40:25Z", eventType: "Authentication", user: "unknown@brute.io", action: "Login Attempt", resource: "/auth/login", ipAddress: "192.0.2.44", status: "failure", duration: 72, details: { requestMethod: "POST", requestPath: "/api/v1/auth/login", responseCode: 401, userAgent: "python-requests/2.31", notes: "Automated brute-force attempt detected – IP added to threat list" } },
  { id: "AUD-064", timestamp: "2026-03-15T11:40:26Z", eventType: "System", user: "system", action: "Threat Detection Alert", resource: "Security: Threat Intelligence", ipAddress: "10.0.10.1", status: "warning", duration: 45, details: { requestMethod: "POST", requestPath: "/internal/security/threats/alert", responseCode: 200, responseBody: '{"threatLevel":"medium","source":"192.0.2.44","action":"auto-blocked"}', notes: "Automated threat response – IP blocked and security team notified" } },
  { id: "AUD-065", timestamp: "2026-03-15T11:45:00Z", eventType: "API", user: "integration-svc", action: "Patient Portal Sync", resource: "/api/v1/portal/sync", ipAddress: "10.0.5.100", status: "success", duration: 1890, details: { requestMethod: "POST", requestPath: "/api/v1/portal/sync", requestPayload: '{"scope":"appointments,results,messages","window":"24h"}', responseCode: 200, responseBody: '{"appointmentsSynced":28,"resultsSynced":15,"messagesSynced":42}', notes: "Patient portal data synchronization completed" } },
  { id: "AUD-066", timestamp: "2026-03-15T11:50:30Z", eventType: "Data Access", user: "nurse.brown@eminence.health", action: "View Care Plan", resource: "Patient #10234 – Care Plan", ipAddress: "10.0.2.72", status: "success", duration: 135, details: { requestMethod: "GET", requestPath: "/api/v1/patients/10234/care-plan", responseCode: 200, notes: "HIPAA audit – nurse reviewed care plan for medication administration" } },
  { id: "AUD-067", timestamp: "2026-03-15T11:55:15Z", eventType: "Clinical", user: "dr.patel@eminence.health", action: "Sign Clinical Note", resource: "Patient #10891 – Progress Note (Signed)", ipAddress: "10.0.3.22", status: "success", duration: 92, details: { requestMethod: "PATCH", requestPath: "/api/v1/patients/10891/notes/latest/sign", requestPayload: '{"signature":"digital","attestation":true}', responseCode: 200, notes: "Clinical note digitally signed and locked for editing" } },
  { id: "AUD-068", timestamp: "2026-03-15T12:00:00Z", eventType: "System", user: "system", action: "Scheduled Maintenance Window", resource: "Maintenance: Read-Only Mode", ipAddress: "10.0.10.1", status: "warning", duration: 15, details: { requestMethod: "POST", requestPath: "/internal/maintenance/schedule", responseCode: 200, responseBody: '{"window":"2026-03-16T02:00:00Z/2026-03-16T04:00:00Z","mode":"read-only"}', notes: "Maintenance window scheduled for database migration – users notified" } },
];
