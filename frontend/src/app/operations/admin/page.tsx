    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Workflow templates, SLA rules, and payer configuration</p>
        </div>
        <Link
          href="/operations"
      ...
      {/* Payer connections */}
      <div className="card">
        <h2 className="mb-3 text-lg font-semibold text-gray-900">Payer Connections</h2>
        <div className="space-y-2">
          {[
            ...
            <div key={payer.name} className="flex items-center justify-between rounded-lg border border-gray-200 p-3">
