...
const PLATFORM_FEATURES = [
  {
    ...
    description: "AI-powered clinical search",
    icon: "M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z",
    color: "text-healthos-600 bg-healthos-50",
    stat: "4 collections",
  },
  {
    label: "Knowledge Graph",
    href: "/knowledge-graph",
    description: "Clinical relationship explorer",
  ...
  },
  {
    label: "ML Models",
    href: "/ml-models",
    description: "Model performance & predictions",
  ...
  },
  {
    label: "EHR Connect",
    href: "/ehr-connect",
    description: "FHIR & HL7v2 interoperability",
  ...
  },
  {
    ...
    href: "/agents",
    description: "Agent pipelines & HITL",
...
export default function DashboardPage() {
  return (
    <div className="space-y-6 bg-mesh min-h-full">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {PLATFORM_FEATURES.map((feature) => (
            <Link
              key={feature.label}
              href={feature.href}
              className="group card card-hover flex flex-col gap-2 !p-4"
            >
      ...
      {/* Federated Learning & Interoperability Status Bar */}
