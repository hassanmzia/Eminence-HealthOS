...
function biasTypeBadge(type: string): string {
  ...
  return map[type] || "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300";
}
...
function TrendIcon({ trend, delta }: { trend: string; delta: number }) {
  ...
  return (
    <span className="flex items-center gap-0.5 text-xs text-gray-500 dark:text-gray-400 font-medium">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
        {[
          ...
          },
          {
            ...
            color: totalAlerts > 0 ? "text-amber-600" : "text-gray-900 dark:text-gray-100",
          },
          {
            label: "Drift Detections",
            value: driftCount,
            icon: <Activity className="w-4 h-4 text-red-500" />,
            color: driftCount > 0 ? "text-red-600" : "text-gray-900 dark:text-gray-100",
          },
          {
            label: "Last Audit",
              ...
              <div key={model.id} className="card card-hover p-5 space-y-4 animate-fade-in-up">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{model.type}</p>
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs text-gray-500 dark:text-gray-400">Overall Fairness</span>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={sub.label} className="flex items-center gap-2">
                      <span className="text-[11px] text-gray-500 dark:text-gray-400 w-32 flex-shrink-0">
                        {sub.label}
                      </span>
          ...
          <div className="card p-5 animate-fade-in-up">
            ...
            <div className="overflow-x-auto">
              <div className="overflow-x-auto -mx-4 sm:mx-0"><table className="w-full text-xs">
                <thead>
                  <tr>
                    <th className="text-left pb-2 pr-4 text-gray-500 dark:text-gray-400 font-medium">Dimension</th>
                    {PROTECTED_GROUPS.map((g) => (
                      <th key={g} className="pb-2 px-2 text-center text-gray-500 dark:text-gray-400 font-medium">
                        {g}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  {FAIRNESS_DIMENSIONS.map((dim, rowIdx) => (
                    <tr key={dim}>
                      <td className="py-1.5 pr-4 font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap">
                        {dim}
                      </td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-healthos-blue focus:border-transparent"
                >
                    ...
                    <label
                      ...
                      className={clsx(
                        ...
                        biasDimensions.includes(dim)
                          ...
                          : "bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:border-gray-300 dark:border-gray-600"
                      )}
                    >
                      <input
                        type="checkbox"
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-medium text-gray-600 dark:text-gray-400">
                        Affected Group: <span className="text-gray-900 dark:text-gray-100">{alert.affectedGroup}</span>
                      </span>
                    </div>
              ...
              {models.map((model) => {
                ...
                return (
                  <div key={model.id} className="flex items-center gap-3">
                    <span className="text-xs font-medium text-gray-700 dark:text-gray-300 w-44 flex-shrink-0 truncate">
                      {model.name}
                    </span>
                    ...
                    {alertCount > 0 && (
                      <span className="text-[11px] bg-red-100 text-red-700 px-1.5 py-0.5 rounded-full font-bold">
                      ...
                      <div className="overflow-x-auto -mx-4 sm:mx-0"><table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-gray-200 dark:border-gray-700">
                            ...
                            <th className="text-center pb-2 text-xs font-medium text-gray-500 dark:text-gray-400">
                              Result
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          {auditResults
                            ...
                            .map((result, idx) => (
                              ...
                              >
                                <td className="py-2.5 text-xs font-medium text-gray-900 dark:text-gray-100">
                                  {result.metric}
                                </td>
                                <td className="py-2.5 text-xs text-gray-500 dark:text-gray-400">
                                  {result.subgroup}
                                </td>
                                <td className="py-2.5 text-right font-mono text-xs font-bold text-gray-900 dark:text-gray-100">
                                  {result.value.toFixed(2)}
                                </td>
                                <td className="py-2.5 text-right font-mono text-xs text-gray-500 dark:text-gray-400">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">
                    <p className="font-medium text-gray-900 dark:text-gray-100 mb-1">Audit Summary</p>
                    <p>
        ...
        <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="space-y-2">
              {DEMO_FEATURE_IMPORTANCE.map((feat) => (
                <div key={feat.feature} className="flex items-center gap-3">
                  <span className="text-xs text-gray-700 dark:text-gray-300 w-40 flex-shrink-0 text-right">
                    {feat.feature}
                  </span>
          ...
          <div className="card p-5 animate-fade-in-up">
            ...
            <div className="flex items-center gap-1 mb-3">
              <span className="text-xs text-gray-500 dark:text-gray-400 flex-shrink-0 w-20">Base: 0.35</span>
              <div className="flex-1 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg relative overflow-hidden flex items-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-3">
              {DEMO_SHAP_FORCES.map((f) => (
                <div
                  key={f.feature}
                  className={clsx(
                    "px-2 py-1.5 rounded text-[11px] font-medium border",
          ...
          <div className="card p-5 animate-fade-in-up">
            ...
            <div className="space-y-3">
              {DEMO_PATIENT_EXPLANATIONS.map((exp, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:border-gray-600 transition-colors"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-bold text-gray-900 dark:text-gray-100">{exp.factor}</span>
                      <span
                        className={clsx(
