    ...
    <header className="flex h-16 items-center justify-between border-b border-gray-200/80 bg-white/80 px-4 backdrop-blur-sm dark:border-gray-700/80 dark:bg-gray-900/80 sm:px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="hidden items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-1.5 text-sm text-gray-400 transition-colors hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-500 dark:hover:bg-gray-700 sm:flex"
        >
          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
          </svg>
          <span className="text-xs">Search...</span>
          <kbd className="rounded border border-gray-300 bg-white px-1.5 py-0.5 text-[10px] font-medium text-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400">⌘K</kbd>
        </button>
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-2 rounded-lg p-1.5 transition-all hover:bg-gray-100 dark:hover:bg-gray-800"
          >
            {user?.avatar_url ? (
              <img
                src={user.avatar_url}
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full z-50 mt-2 w-64 animate-scale-in rounded-xl border border-gray-200/80 bg-white py-1 shadow-lg dark:border-gray-700 dark:bg-gray-900">
              {/* User info header */}
              <div className="border-b border-gray-100 px-4 py-3 dark:border-gray-800">
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{user?.full_name || "User"}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">{user?.email}</p>
                <span className="mt-1.5 inline-block rounded-full bg-healthos-50 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-healthos-700 ring-1 ring-inset ring-healthos-500/20 dark:bg-healthos-950/50 dark:text-healthos-400">
                  {user?.role}
                </span>
              </div>
