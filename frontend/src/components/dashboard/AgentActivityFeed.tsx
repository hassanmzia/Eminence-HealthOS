  ...
  return (
    <div className="card">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Agent Activity</h2>
      ...
      <div className="space-y-1">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">No recent agent activity</p>
          </div>
        ) : (
          events.slice(0, 6).map((event, i) => (
            <div
              key={event.id}
              className="flex items-start gap-3 rounded-lg px-2 py-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 animate-fade-in"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  <span className="font-semibold text-gray-900 dark:text-gray-100">{event.agent_name}</span>{" "}
                  <span className="text-gray-500 dark:text-gray-400">{event.action}</span>
                </p>
