  ...
  if (loading) {
    return (
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-5">
        <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">KPI Scorecard</h2>
  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-5">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">KPI Scorecard</h2>
      ...
      <div className="space-y-2">
        {scorecard.map((s) => {
          ...
          return (
            <div key={s.kpi} className="flex items-center justify-between rounded-lg border border-gray-100 dark:border-gray-800 px-3 py-2">
              <div className="flex items-center gap-2">
                <span className={`h-2 w-2 rounded-full ${style.dot}`} />
                <span className="text-sm text-gray-900 dark:text-gray-100">{s.kpi}</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{s.actual}</span>
                <span className="text-xs text-gray-500 dark:text-gray-400">/ {s.target}</span>
