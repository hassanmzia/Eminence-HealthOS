"""
Eminence HealthOS -- NL2SQL Query Tools

Re-exports the core ``nl2sql_query`` tool from ``base_tools`` and adds a
query validation helper that checks generated SQL for safety before
execution.

No Django dependency -- all configuration via Pydantic settings / env vars.
"""
...
from tools.base_tools import nl2sql_query  # noqa: F401 -- re-export

logger = logging.getLogger("healthos.tools.nl2sql")
...
NL2SQL_TOOLS = [validate_nl2sql_query, safe_nl2sql_query]
