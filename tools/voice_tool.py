"""
Eminence HealthOS -- Voice Transcription Tools

Re-exports the core ``transcribe_voice`` tool from ``base_tools`` and adds
helpers for structuring free-text clinical notes from voice transcriptions
into standard sections and extracting clinical entities.
...
from tools.base_tools import transcribe_voice  # noqa: F401 -- re-export

logger = logging.getLogger("healthos.tools.voice")
...
VOICE_TOOLS = [transcribe_and_structure, extract_clinical_entities]
