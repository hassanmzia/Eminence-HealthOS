"""
Eminence HealthOS -- Qdrant Vector Search Tools

Re-exports the core ``vector_search`` tool from ``base_tools`` and adds
...
from tools.base_tools import vector_search  # noqa: F401 -- re-export

logger = logging.getLogger("healthos.tools.vector")
...
VECTOR_TOOLS = [search_clinical_guidelines, search_pubmed_vectors]
