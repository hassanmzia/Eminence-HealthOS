#!/usr/bin/env python3
"""
Eminence HealthOS — IoT Device Simulator

Generates realistic wearable vital-sign data with LOINC coding
and sends it to the HealthOS backend API.
...
Usage:
    python scripts/iot_simulator.py \
        ...
        --interval 30 \
        --duration 300 \
        --api-url http://localhost:4090/api/v1/clinical/vitals/ \
        --anomaly-chance 0.05
"""
...
def main():
    parser = argparse.ArgumentParser(description="HealthOS IoT Device Simulator")
    ...
    parser.add_argument(
        "--api-url",
        default="http://localhost:4090/api/v1/clinical/vitals/",
