...
from platform.api.middleware.audit import AuditMiddleware
from platform.api.routes import agents, alerts, auth, fhir, patients, vitals
from platform.config import get_settings
from platform.database import close_db
