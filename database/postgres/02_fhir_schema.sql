-- ============================================================
-- Eminence HealthOS - FHIR R4 Schema
-- Reference schema for Alembic migrations
--
-- Depends on: 01_tenant_schema.sql (organizations table)
-- ============================================================
...
CREATE INDEX idx_fhir_appt_start ON fhir_appointment(start_time);
...
-- ============================================================
-- Tenant FK constraints for tables that reference organizations
-- ============================================================
DO $$
BEGIN
    IF NOT EXISTS (
