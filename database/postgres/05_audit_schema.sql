-- ============================================================
-- Eminence HealthOS - HIPAA Audit Schema
-- Reference schema for Alembic migrations
--
-- Implements comprehensive audit logging for HIPAA compliance.
-- Depends on: 02_fhir_schema.sql (fhir_patient, patient_demographics)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS audit_log (
    ...
    CONSTRAINT audit_log_no_delete CHECK (TRUE)  -- enforced via rules below
);
